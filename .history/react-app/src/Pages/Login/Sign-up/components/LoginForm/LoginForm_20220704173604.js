    ...
    <Container>
      ...
      <Row  className="justify-content-center">
        <Form style={{ width: 300, height: 450 }}>
          <Form.Group onSubmit={saveProduct} as={Col} controlId="formGridEmail" className="groupfrom">
          ...
          <Form.Group  onSubmit={saveProduct} className="groupfrom " as={Col} controlId="formGridEmai">
          ...
          <div className="field">
            <Button onSubmit={saveProduct} className="button is-primary" >Kayıt ol</Button>
          </div>
        </Form>
      </Row>
    </Container>
